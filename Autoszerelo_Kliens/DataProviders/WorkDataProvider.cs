...
namespace Autoszerelo_Kliens.DataProviders
{
    public static class WorkDataProvider
    {
        ...
        {
            //Emberek listáját lekérjük a szerverről
            using (var client = new HttpClient())
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    //Ez json lesz és deszerializációval person-ök kollekciójává kell alakítani
